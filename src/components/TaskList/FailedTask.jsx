  ...
  return (
    <div className=' flex-shrink-0 h-full w-[300px] bg-pink-400 rounded-xl'>
            ...
            <div  className='flex justify-between  mt-4'>
              {/* <button className='bg-green-500 py-1 px-2 text-sm ml-4 rounded'>Mark ad Completed</button> */}
              <button className='bg-red-500 py-1 px-2 text-sm ml-36 rounded'>Failed</button>
           </div>
